...
import { apiCompleteRegister } from '../apis/user'; // Đảm bảo bạn import đúng đường dẫn tới file chứa hàm api
...
const CompleteRegister = ({ route, navigation }) => {
  ...
  return (
    <View style={styles.container}>
      {status === 'failed' ? (
        <>
          <Text style={styles.message}>Register failed. Please try again.</Text>
