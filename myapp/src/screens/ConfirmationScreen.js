                    ...
                    <Pressable>
                        {addresses?.map((item, index) => (
                            <Pressable style={styles.addressContainer}>
                                ...
                                <View
                                    style={styles.addressesInfoBorderContainer}
                                >
            ...
            {currentStep == 1 && (
                <View style={styles.deliveryOptionContainer}>
                    ...
                    <View style={styles.infoOptionContainer}>
                        ...
                        <Text style={styles.infoOptionTextContainer}>
                            <Text style={styles.infoOptionText}>Tomorrow</Text>{' '}
                            - Free shipping with paypal payment
                        </Text>
                    </View>
                ...
                <View style={styles.orderContainer}>
                    ...
                    <View style={styles.shippingAddressContainer}>
                        ...
                        <View style={styles.shippingDetailAddressContainer}>
                            <Text style={styles.shippingDetailAddressHeader}>
                                Items
                            </Text>
