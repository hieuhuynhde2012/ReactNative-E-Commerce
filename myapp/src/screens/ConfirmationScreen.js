...
const ConfirmationScreen = () => {
    ...
    const [isShownPayment, setIsShownPayment] = useState(false);
        ...
        Alert.alert(
            ...
            [
                ...
                },
                {
                    ...
                    onPress: async () => {
                        try {
                            const response = await apiDeleteAdditionalAddress(
                                addressId,
                            );
                            if (response.success) {
    ...
    return (
        <View style={styles.outerContainer}>
                            ...
                            <Pressable>
                                {addresses?.map((item, index) => (
                                    <Pressable style={styles.addressContainer}>
                                        ...
                                        <View
                                            style={
                                                styles.addressesInfoBorderContainer
                                            }
                                        >
                                            <View
                                                style={
                                                    styles.addressesInfoContainer
                                                }
                                            >
                                                <Text
                                                    style={
                                                        styles.addressesInfoText
                                                    }
                                                >
                                                    {item?.name}
                                                </Text>
                                            ...
                                            <Text
                                                style={
                                                    styles.addressesDetailInfoText
                                                }
                                            >
                                                {item?.houseNo},{' '}
                                                {item?.landmark}
                        ...
                        <View>
                            {optionDelivery.map((item) => (
                                ...
                                >
                                    ...
                                    <Text
                                        style={styles.infoOptionTextContainer}
                                    >
                    ...
                    <View style={styles.orderContainer}>
                        ...
                        <View style={styles.shippingAddressContainer}>
                            ...
                            <View style={styles.shippingDetailAddressContainer}>
                                <Text
                                    style={styles.shippingDetailAddressHeader}
                                >
                                    Items
                                </Text>

                                <Text style={styles.shippingDetailAddressText}>
                                    {currentCart?.reduce(
                            ...
                            <View style={styles.shippingDetailAddressContainer}>
                                <Text style={styles.orderDetailContainer}>
                                    Order total
                                </Text>
            ...
            <View style={styles.bottomCtrlBtnWrapper}>
                <TouchableOpacity
                ...
                >
                    <Ionicons
                        ...
                        color="black"
                    />
                    <Text>Back to previous stage</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={styles.bottomCtrlBtn}
                    onPress={() => {
                ...
                >
                    <View style={styles.bottomCtrlImg}>
